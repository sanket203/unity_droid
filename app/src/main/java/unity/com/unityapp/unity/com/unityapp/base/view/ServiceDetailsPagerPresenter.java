...
public class ServiceDetailsPagerPresenter extends BasePresenter<ServiceDetailsPagerView> {
    ...
    public ServiceDetailsPagerPresenter(GetPersonalDetailsUseCase getPersonalDetailsUseCase, PersonalDetailsDataModelToViewModelMapper personalDetailsDataModelToViewModelMapper) {
