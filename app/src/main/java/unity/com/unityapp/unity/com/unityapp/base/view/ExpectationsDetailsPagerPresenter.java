...
public class ExpectationsDetailsPagerPresenter extends BasePresenter<ExpectationsDetailsPagerView> {
    ...
    public ExpectationsDetailsPagerPresenter(GetPersonalDetailsUseCase getPersonalDetailsUseCase, PersonalDetailsDataModelToViewModelMapper personalDetailsDataModelToViewModelMapper) {
